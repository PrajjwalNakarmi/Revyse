...
export default function Login() {
  ...
  return (
    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#f5f4ef] px-4 py-6 sm:px-6 lg:px-8">
      ...
      <div className="relative mx-auto grid w-full max-w-6xl overflow-hidden rounded-3xl border border-[#0f766e]/20 bg-[#0d242d]/95 shadow-[0_30px_120px_-70px_rgba(0,0,0,0.55)] backdrop-blur-md lg:grid-cols-2">
